...
## Project Structure
    ...
    ├── testapiautosetting_101157  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_101157`
...
2. Clone this repo and `cd testapiautosetting_101157`
